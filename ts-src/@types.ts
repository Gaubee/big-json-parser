declare namespace GoWasm {
  ...
  interface GaubeeCom_JsonStreamReader {
    ...
    write(
      id: number,
      chunk: GaubeeCom_JsonStreamReader.Chunk,
      len: number
    ): number;
    walk(
      id: number,
      op: GaubeeCom_JsonStreamReader.JsonStreamWalkOperator
    ):
      | GaubeeCom_JsonStreamReader.JsonStreamDelimEnum
      | GaubeeCom_JsonStreamReader.JsonStreamPauseSignEnum
      | unknown;
...
declare namespace JsonStream {
  ...
  interface Parser {
    ...
    readObject(): { [key: string]: unknown } | PauseSignEnum;
    read(
      op: GoWasm.GaubeeCom_JsonStreamReader.JsonStreamWalkOperator
    ):
      | DelimEnum
      | PauseSignEnum
      | undefined
